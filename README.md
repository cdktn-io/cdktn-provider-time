...
# CDKTN prebuilt bindings for hashicorp/time provider version 0.14.2

This repo builds and publishes the [Terraform time provider](https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform time provider](https://registry.terraform.io/providers/hashicorp/time/0.14.2)
