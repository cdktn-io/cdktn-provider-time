...
// https://registry.terraform.io/providers/hashicorp/time/0.14.1/docs/resources/offset
...
export class Offset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Offset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/time/0.14.1/docs/resources/offset#import import section} in the documentation of this resource for the id to use
