...
// https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs
...
export class TimeProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing TimeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs time} Resource
  *
  * @param scope The scope in which to define this construct
