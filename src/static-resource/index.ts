...
// https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs/resources/static
...
export class StaticResource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StaticResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs/resources/static#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs/resources/static time_static} Resource
  *
  * @param scope The scope in which to define this construct
