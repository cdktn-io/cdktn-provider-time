...
// https://registry.terraform.io/providers/hashicorp/time/0.14.0/docs/resources/rotating
...
export class Rotating extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Rotating that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/time/0.14.0/docs/resources/rotating#import import section} in the documentation of this resource for the id to use
