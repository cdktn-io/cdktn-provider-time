...
// https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs/resources/sleep
...
export interface SleepConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class Sleep extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Sleep that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs/resources/sleep#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Sleep to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "time_sleep", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/time/0.14.2/docs/resources/sleep time_sleep} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      create_duration: cdktn.stringToTerraform(this._createDuration),
      destroy_duration: cdktn.stringToTerraform(this._destroyDuration),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      create_duration: {
        value: cdktn.stringToHclTerraform(this._createDuration),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      destroy_duration: {
        value: cdktn.stringToHclTerraform(this._destroyDuration),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
