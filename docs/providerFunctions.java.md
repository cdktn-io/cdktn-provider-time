...
```java
import io.cdktn.providers.time.provider_functions.TimeProviderFunctions;

new TimeProviderFunctions(java.lang.String providerLocalName);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-time.providerFunctions.TimeProviderFunctions.Initializer.parameter.providerLocalName">providerLocalName</a></code> | <code>java.lang.String</code> | The local name of the provider in required_providers; |
...
```java
public IResolvable durationParse(java.lang.String duration)
```
...
```java
public IResolvable rfc3339Parse(java.lang.String timestamp)
```
...
```java
public IResolvable unixTimestampParse(java.lang.Number unixTimestamp)
```
